        ...
        <div className="flex flex-wrap items-center justify-between -mx-4">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="mt-10 lg:mt-0">
              ...
              <div>
                <h4 className='text-2xl font-bold text-red-500'>Skills</h4>
                {/* progress groups */}
                <div className="flex w-full flex-col gap-3 my-9 text-black">

                  {/* progress bar1 */}
                  <div className='flex flex-col gap-1 justify-start'>
                    <span className='font-bold text-sm'>Adobe Illustrator</span>
                    <progress className="progress progress-success w-96 h-4" value="95" max="100"></progress>
                  </div>

                  {/* progress bar1 */}
                  <div className='flex flex-col gap-1 justify-start'>
                    <span className='font-bold text-sm'>Adobe Photoshop</span>
                    <progress className="progress progress-success w-96 h-4" value="85" max="100"></progress>
                  </div>
                  {/* progress bar1 */}
                  <div className='flex flex-col gap-1 justify-start'>
                    <span className='font-bold text-sm'>Adobe Indesign</span>
                    <progress className="progress progress-success w-96 h-4" value="70" max="100"></progress>
                  </div>
                  {/* progress bar1 */}
                  <div className='flex flex-col gap-1 justify-start'>
                    <span className='font-bold text-sm'>Adobe XD</span>
                    <progress className="progress progress-success w-96 h-4" value="60" max="100"></progress>
                  </div>
